...
def scanDipoles(b_small, b_big):
    ...
    for i in range(total_steps):
        ...
        sleep(5)
        bb_new = GetMagnet(b_big)

        bs_hall = GetHall(b_small)
        bb_hall = GetHall(b_big)
        print(f"Currents: {bs_init:.6f}, {bb_init:.6f}, {bb_new:.6f}")
        ...
        while(bs_hall>=bb_hall):
            ...
            SetMagnet( b_small,   bs_i - bs_stepsize)
...
quad_pair = ['q6', 'q9'] ##### !!!! EDITED FOR B3-B4 downstream tuning !!!!!!
viewer = 'D1688'
